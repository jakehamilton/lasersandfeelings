...
const ActionButton: FunctionComponent<ActionButtonProps> = ({
	...
	return (
		<DynamicElement
			as={as}
			{...props}
			class={`relative cursor-pointer rounded no-underline inline-flex font-sans font-bold bg-purple-600 mt-2 py-2 px-5 transform transition-all text-light-900 scale-100 duration-175 prose-lg items-center focus:active:bg-purple-800 ${
				props.loading
					? ""
